...
public class report {
	...
	public static ExtentHtmlReporter StartHtmlFinalReport(ExtentHtmlReporter htmlReporter, String DeviceName,
			String ResultFolderPath) {

		htmlReporter = new ExtentHtmlReporter(
				(ResultFolderPath + "Consolidated_ExtentReport_" + DeviceName + Util.randomNum() + ".html"));
	...
	public static ExtentReports StartExtentReport(ExtentHtmlReporter htmlReporter, ExtentReports extent) {
		Properties prop = propertiesRead.readProperties();
	...
	public static ExtentTest testCreate(ExtentReports extent, String Stepdetails) {
		ExtentTest test = extent.createTest(Stepdetails, Stepdetails);
		return test;
	}
	...
	public static void PassTest(ExtentTest test, WebDriver driver, String Stepdetails, String screenshotName) {
		try {
			...
			String ResultFolderPath = System.getProperty("user.dir") + "\\test-output\\IndividualTestReports\\ScreenShot";
